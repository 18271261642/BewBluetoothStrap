...
import com.example.bozhilun.android.onekeyshare.themes.classic.EditPage;
import com.example.bozhilun.android.onekeyshare.themes.classic.XView;
...
public class EditPagePort extends EditPage {
	...
	public void onCreate() {
		...
		rlTitle.setBackgroundColor(0xff3b3b3b);
		...
		rlBody.setBackgroundColor(0xff3b3b3b);
	...
	private void initBottom(LinearLayout llBottom, float ratio) {
		...
		llAt.setBackgroundColor(0xff3b3b3b);
		...
		v.setBackgroundColor(0xff3b3b3b);
