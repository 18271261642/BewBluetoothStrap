...
import com.example.bozhilun.android.b15p.B15PDeviceActivity;
 ...
 */
public class B15pMineFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        b15pMineView = inflater.inflate(R.layout.fragment_b18i_mine, container, false);
        unbinder = ButterKnife.bind(this, b15pMineView);
    ...
    private void initData() {
        ...
        subscriberOnNextListener = new SubscriberOnNextListener<String>() {
            ...
            public void onNext(String result) {
                //{"userInfo":{"birthday":"1994-12-27",
                // "image":"http://47.90.83.197/image/2017/07/31/1501490388771.jpg",
                // "nickName":"孙建华","sex":"M","weight":"60 kg",
                // "userId":"5c2b58f0681547a0801d4d4ac8465f82",
                // "phone":"15916947377","height":"175 cm"},"resultCode":"001"}
                    ...
                    try {
                        ...
                        if (jsonObject.getString("resultCode").equals("001")) {
                            ...
                            if (myInfoJsonObject != null) {
                                ...
                                if (sex != null){
                                    SharedPreferencesUtils.setParam(getActivity(), "usersex", sex.trim());
                                }
                                String weight = myInfoJsonObject.getString("weight");
                                if (sex != null){
                                    if (weight.contains("kg")) {
                                        String newHeight = weight.substring(0, weight.length() - 2);
                                        SharedPreferencesUtils.setParam(getActivity(), "userweight", newHeight.trim());
                                    } else {
                                        SharedPreferencesUtils.setParam(getActivity(), "userweight", weight.trim());
                                    }
                                }
                            }
                        }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.privatemode_cardview://排行榜
                startActivity(new Intent(getActivity(), B18IRankingListActivity.class).putExtra("is18i", "B15P"));
                break;
            case R.id.targetSetting://目标设置
                startActivity(new Intent(getActivity(), B18ITargetSettingActivity.class).putExtra("is18i", "B15P"));
                break;
            ...
            case R.id.smartAlert://功能设置-----改----》mine_dev_image
                if (MyCommandManager.DEVICENAME != null) {    //已连接
                    //startActivity(new Intent(getActivity(), B18ISettingActivity.class).putExtra("is18i", "B15P"));
            ...
            case R.id.findFriends://查找朋友
                startActivity(new Intent(getActivity(), FindFriendActivity.class).putExtra("is18i", "B15P"));
                break;
            case R.id.mineSetting://设置
                startActivity(new Intent(getActivity(), B18IAppSettingActivity.class).putExtra("is18i", "B15P"));
                break;
        }
    }
