...
import com.example.bozhilun.android.activity.wylactivity.wyl_util.RainFlake;
...
public class RainView extends View {
    ...
    private static final int NUM_SNOWFLAKES = 60; // 雨滴数量
    ...
    private void initSnow(int width, int height) {
        ...
        paint.setColor(Color.parseColor("#80ffffff")); // 雨滴的颜色
