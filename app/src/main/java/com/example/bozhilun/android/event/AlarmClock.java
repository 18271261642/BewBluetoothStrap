 ...
 *
 */
package com.example.bozhilun.android.event;
...
public class AlarmClock extends DataSupport implements Parcelable {
    ...
    public AlarmClock(int hour, int minute, String repeat,
                      ...
                      int napInterval, int napTimes, boolean weaPrompt, boolean onOff,int shiliu,int alock_id) {
        super();
        this.hour = hour;
        this.minute = minute;
        this.repeat = repeat;
    ...
    public void setShiliu(int shiliu){
        this.shiliu = shiliu;
    }

    public int getShiliu(){
        return shiliu;
    }

    public void setAlock_id(int alock_id){
        this.alock_id = alock_id;
    }

    public int getAlock_id(){
        return alock_id;
    }
