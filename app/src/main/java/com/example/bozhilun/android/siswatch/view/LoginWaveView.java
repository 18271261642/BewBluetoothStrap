...
public class LoginWaveView extends View {
    ...
    public LoginWaveView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LoginWaveView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mLeftPoints = new ArrayList<>();
        mRightPoints = new ArrayList<>();
    }
