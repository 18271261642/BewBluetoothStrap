...
public class PlusCloudyView extends View {
    ...
    public PlusCloudyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PlusCloudyView(Context context, AttributeSet attrs, int defStyleAttr) {
