...
import com.example.bozhilun.android.B18I.b18irenderer.B18ILeafLineRenderer;
...
public class LeafLineChart extends AbsLeafChart {
    ...
    private B18ILeafLineRenderer leafChartRenderer;
    ...
    protected void initRenderer() {
        leafChartRenderer = new B18ILeafLineRenderer(mContext, this);
    }
